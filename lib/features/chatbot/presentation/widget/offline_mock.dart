...
final mockOfflineTopics = [
  OfflineTopicEntity(
    ...
    enDescription: 'Learn how to manage indigestion symptoms and when to seek medical care.',
    amDescription: 'የሆድ ያልተረጋጋነትን ምልክቶች እንዴት እንደሚያቆጡ እና መቼ የሕክምና እገዛ መፈለግ እንዳለብዎት ይወቁ።',
